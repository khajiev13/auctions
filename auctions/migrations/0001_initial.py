# Generated by Django 4.1.4 on 2022-12-29 03:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(default='Description Not Provided', max_length=500)),
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('active', models.BooleanField(default=True)),
                ('image_url', models.URLField(blank=True, max_length=255, null=True)),
                ('category_id', models.ManyToManyField(blank=True, null=True, related_name='category_listings', to='auctions.category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bits_made', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
